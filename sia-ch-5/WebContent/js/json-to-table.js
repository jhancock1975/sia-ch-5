...
/**
 * john #stock-4
 * original function overload - pass null title
 * @param parsedJson
 * @param tableId
...
function ConvertJsonToTable(parsedJson, tableId, tableClassName, linkText){
	return ConvertJsonToTable(parsedJson, tableId, tableClassName, linkText, null);
}
/**
 ...
 * @author John Hancock <jhancock1975 at gmail dot com>
 ...
 * 
 * @param title - copied to <caption> element of table
 * @return string Converted JSON to HTML table
 */
function ConvertJsonToTable(parsedJson, tableId, tableClassName, linkText, title)
{
    ...
    var classMarkup = tableClassName ? ' class="' + tableClassName + '"' :
                                       '';
    //john  #4 2013-06-30
    //add title if passed as parameter
    var caption = '';
    if (title){
    	caption = '<caption>' + title + '</caption>';
    }
    
    var tbl = '<table border="1" cellpadding="1" cellspacing="1"' + idMarkup + classMarkup + 
    	'>' + caption +'{0}{1}</table>';
